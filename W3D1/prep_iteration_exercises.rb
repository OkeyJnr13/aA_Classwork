...
def factors(num)
  ...
  (1..num).each {|fact| results << fact if num % fact == 0}
...
# p a.object_id
# p (a.bubble_sort { |num1, num2| num2 <=> num1 }).object_id #sort descending
# p a.object_id
...
def subwords(word, dictionary)
  ...
  words.select {|ele| dictionary.include?(ele)}
end
